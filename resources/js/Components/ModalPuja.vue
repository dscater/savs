...
const registrarPuja = () => {
    ...
    axios
        .post(route("subastas.registrarPuja"), {
            ...
            participante_id: oParticipante.value.id,
        })
        .then((response) => {
            oParticipante.value.historial_ofertas =
                response.data.participante.historial_ofertas;
            error_monto.value = false;
    ...
    axios
        ...
        .then((response) => {
            ...
            if (montoInicial.value && montoInicial.value != "-") {
                ...
                if (oSubasta.value.participantes_puja.length > 0) {
                    monto_puja.value++;
                }
            }
        });
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div
                                ...
                                v-show="
                                    !oParticipante ||
                                    oParticipante.estado_comprobante == 0
                                "
                            >
                                <div class="col-12">
                                    <div
                                        class="border p-2 rounded elevation-1 text-justify"
                            ...
                            <div
                                ...
                                v-show="
                                    oParticipante &&
                                    oParticipante.estado_comprobante == 1
                                "
                            >
                                <div class="col-12">
                                    <div
                                        class="alert alert-info mb-2 text-sm font-weight-bold"
                                    >
                                        Verifica tu oferta antes de registrarla
                                    </div>
                                </div>
                            </div>
                            <form
