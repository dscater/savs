...
const registrarComprobante = () => {
    ...
    if (oParticipante.value) {
        formdata.append("participante_id", oParticipante.value.id);
    }

    axios
        .post(route("subastas.registrarComprobante"), formdata, config)
        .then((response) => {
            oParticipante.value = response.data.participante;
            enviando.value = false;
            dialog.value = false;
            Swal.fire({
                icon: "success",
            ...
            emits("envio-formulario", oParticipante.value);
        })
        .catch((error) => {
            enviando.value = false;
            // dialog.value = false;
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a
                                href="#"
                                class="btn btn-outline-primary w-100 mb-2 font-weight-bold"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p>
                                ...
                                {{ getFormatoMoneda(oPublicacion.garantia) }}
                            </p>
