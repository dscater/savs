...
const generarReporte = () => {
    ...
    const url = route("reportes.r_subastas", form.value);
...
<template>
    <Head title="Reporte Lista de Subastas"></Head>
    <Content>
        <template #header>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Reporte Lista de Subastas</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
