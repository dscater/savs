            ...
            <div class="modal-content">
                    ...
                    <div class="row" v-if="oSubastaCliente">
                        <div class="col-12">
                            <p>
                                ...
                                {{ oSubastaCliente.user?.full_name }}
                            </p>
                            <p>
                                <strong>C.I.: </strong
                                >{{ oSubastaCliente.user?.user_dato?.full_ci }}
                            </p>
                            <p>
                                <strong>Número de celular: </strong
                                >{{ oSubastaCliente.user?.fono }}
                            </p>
                            <h4
                                class="card-title font-weight-bold text-center w-100 mb-2"
                            >
                                - Datos para devolución -
                            </h4>
                            <p>
                                <strong>Banco: </strong
                                >{{ oSubastaCliente.user?.user_dato?.banco }}
                            </p>
                            <p>
                                <strong>Número de cuenta: </strong
                                >{{
                                    oSubastaCliente.user?.user_dato?.nro_cuenta
                                }}
                            </p>
                            <p class="" v-if="oPublicacion">
                                <strong>MONTO DE GARANTÍA: </strong>Bs.
                                {{ oPublicacion.garantia }}
                            </p>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <div
                                class="w-100"
                                v-if="form.errors?.descripcion_devolucion"
                            >
                                <span
                                    class="invalid-feedback alert alert-danger"
                                    style="display: block"
                ...
                <div class="modal-footer justify-content-end">
                    ...
                    <button
                        v-if="
                            auth?.user.permisos == '*' ||
                            auth?.user.permisos.includes('subastas.edit')
                        "
                        type="button"
